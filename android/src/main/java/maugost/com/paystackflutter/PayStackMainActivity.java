...
public class PayStackMainActivity extends AppCompatActivity {
        ...
        mButtonPerformTransaction.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    PayStackMainActivity.this.mTextError.setText(String.format("An error occurred while charging card: %s %s", e.getClass().getSimpleName(), e.getMessage()));
    ...
    private void startAFreshCharge(boolean local) {
        ...
        dialog = new ProgressDialog(PayStackMainActivity.this);
    ...
    private void chargeCard() {
        transaction = null;
        PaystackSdk.chargeCard(PayStackMainActivity.this, charge, new Paystack.TransactionCallback() {
            // This is called only after transaction is successful
            @Override
            public void onSuccess(Transaction transaction) {
                dismissDialog();

                PayStackMainActivity.this.transaction = transaction;
                mTextError.setText(" ");
                Toast.makeText(PayStackMainActivity.this, transaction.getReference(), Toast.LENGTH_LONG).show();
                updateTextViews();
            ...
            public void onError(Throwable error, Transaction transaction) {
                ...
                if (error instanceof ExpiredAccessCodeException) {
                    PayStackMainActivity.this.startAFreshCharge(false);
                    PayStackMainActivity.this.chargeCard();
                    return;
                }
                ...
                if (transaction.getReference() != null) {
                    Toast.makeText(PayStackMainActivity.this, transaction.getReference() + " concluded with error: " + error.getMessage(), Toast.LENGTH_LONG).show();
                    ...
                    Toast.makeText(PayStackMainActivity.this, error.getMessage(), Toast.LENGTH_LONG).show();
    ...
    private class fetchAccessCodeFromServer extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (result != null) {
                ...
                PayStackMainActivity.this.mTextBackendMessage.setText(String.format("There was a problem getting a new access code form the backend: %s", error));
                dismissDialog();
            }
        }
    ...
    private class verifyOnServer extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            super.onPostExecute(result);
            if (result != null) {
                PayStackMainActivity.this.mTextBackendMessage.setText(String.format("Gateway response: %s", result));

            } else {
                PayStackMainActivity.this.mTextBackendMessage.setText(String.format("There was a problem verifying %s on the backend: %s ", this.reference, error));
                dismissDialog();
            }
        }
